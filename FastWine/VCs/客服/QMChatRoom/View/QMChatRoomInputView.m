...
- (void)createView {
    ...
    //输入框
    self.inputView = [[UITextView alloc] initWithFrame:CGRectMake(50, 8, SCREEN_WIDTH-140, 34)];
    ...
    self.RecordBtn.frame = CGRectMake(50, 8, SCREEN_WIDTH-140, 34);
    ...
    self.faceButton.frame = CGRectMake(SCREEN_WIDTH-kInputViewHeight*2+20, 0, kInputViewHeight-10, kInputViewHeight);
    ...
    self.addButton.frame = CGRectMake(SCREEN_WIDTH-kInputViewHeight+10, 0, kInputViewHeight-10, kInputViewHeight);
    self.addButton.tag = 3;
    [self.addButton setImage:[UIImage imageNamed:@"ToolBar_Add"] forState:UIControlStateNormal];
    [self addSubview: self.addButton];
    
    self.coverView = [[UIView alloc] init];
    self.coverView.frame = CGRectMake(0, 0, SCREEN_WIDTH, kInputViewHeight);
