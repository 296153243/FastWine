...
- (void)createUI {
    ...
    self.backView = [[UIView alloc] initWithFrame:CGRectMake(30, 65, SCREEN_WIDTH - 60, 376)];
    ...
    self.backView.frame = CGRectMake(30, 65, SCREEN_WIDTH - 60, CGRectGetMaxY(self.cancelButton.frame) + 25);
...
- (void)createReason:(NSInteger)number {
    ...
    self.radioView.frame = CGRectMake(25, self.optionHeight + 25, SCREEN_WIDTH - 60 - 50, [self calcHeight:self.evaluation.evaluats[number].reason]);
...
- (BOOL)textViewShouldBeginEditing:(UITextView *)textView {
    [UIView animateWithDuration:0.3 animations:^{
        self.backView.frame = CGRectMake(30, 0, SCREEN_WIDTH - 60, CGRectGetMaxY(self.cancelButton.frame) + 25);
    }];
    return true;
}
