...
- (void)setup{
    ...
    UIScrollView *scrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(0.0f,5.0f,CGRectGetWidth(self.bounds),CGRectGetHeight(self.bounds)-(IS_iPhoneX ? 34 : 0)-FacePageControlHeight-FaceSectionBarHeight)];
    ...
    self.sendButton.frame = CGRectMake(self.bounds.size.width-70, self.bounds.size.height-(IS_iPhoneX ? 34 : 0)-30, 50, 30);
