...
+(void)showMessage:(NSString *)message{
    ...
    CGSize LabelSize = [message boundingRectWithSize:CGSizeMake(SCREEN_WIDTH - 100, 0) options: NSStringDrawingTruncatesLastVisibleLine | NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attribute context:nil].size;
    ...
    showview.frame = CGRectMake((SCREEN_WIDTH - LabelSize.width - 20)/2, SCREEN_HEIGHT - label.frame.size.height - 180, LabelSize.width + 20, LabelSize.height + 10);
