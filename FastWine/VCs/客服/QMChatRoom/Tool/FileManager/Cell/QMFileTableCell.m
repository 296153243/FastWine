...
- (void)createUI {
    ...
    _fileName.frame = CGRectMake(90, 10, SCREEN_WIDTH-150, 20);
    ...
    _fileSize.frame = CGRectMake(90, 30, SCREEN_WIDTH-150, 20);
    ...
    _fileDate.frame = CGRectMake(90, 50, SCREEN_WIDTH-150, 20);
