...
-(void)createUI {
    ...
    _videoName.frame = CGRectMake(90, 10, SCREEN_WIDTH-150, 20);
    ...
    _videoSize.frame = CGRectMake(90, 30, SCREEN_WIDTH-150, 20);
    ...
    _videoDate.frame = CGRectMake(90, 50, SCREEN_WIDTH-150, 20);
    ...
    self.pickedItemImageView.frame = CGRectMake(SCREEN_WIDTH-50, 25, 30, 30);
