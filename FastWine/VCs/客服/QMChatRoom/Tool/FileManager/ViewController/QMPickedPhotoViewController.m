...
- (void)viewDidLoad {
    ...
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT-_navHeight-44) collectionViewLayout:layout];
    ...
    _tabbarView.frame = CGRectMake(0, SCREEN_HEIGHT-44-_navHeight, SCREEN_WIDTH, 44);
