...
- (void)setData:(CustomMessage *)message avater:(NSString *)avater {
    ...
    if ([message.fromType isEqualToString:@"1"]) {
        ...
        if ([message.richTextPicUrl  isEqual: @""]) {
            ...
            [_imageView sd_setImageWithURL:[NSURL URLWithString:message.richTextPicUrl] placeholderImage:[UIImage imageNamed:nil]];
        }
        ...
        if ([message.cardImage  isEqual: @""]) {
            ...
            _imageView.hidden = NO;
            [_imageView sd_setImageWithURL:[NSURL URLWithString:message.cardImage] placeholderImage:[UIImage imageNamed:nil]];
        }
