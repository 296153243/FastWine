...
- (void)layoutView {
    ...
    self.indicatorView.frame = CGRectMake((SCREEN_WIDTH-100)/2, (SCREEN_HEIGHT-100)/2-64, 100, 100);
...
- (void)buttonAction:(UIButton *)sender {
     ...
     */    
        ...
        [QMConnect registerSDKWithAppKey:@"e183f850-6650-11e9-b942-bf7a16e827df" userName:@"MOSOONso" userId:@"232444112"];
...
- (void)showChatRoomViewController:(NSString *)peerId processType:(NSString *)processType entranceId:(NSString *)entranceId {
    ...
    chatRoomViewController.backBlock = ^{
       //返回
